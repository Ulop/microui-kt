...
val ATLAS_WHITE = Icon.MAX.ordinal
val ATLAS_FONT = ATLAS_WHITE + 1
const val ATLAS_WIDTH = 128
const val ATLAS_HEIGHT = 128

val atlasTexture = byteArrayOf(
...
val atlas = mapOf(
    Icon.CLOSE.ordinal to Rect(88, 68, 16, 16),
    Icon.CHECK.ordinal to Rect(0, 0, 18, 18),
    Icon.EXPANDED.ordinal to Rect(118, 68, 7, 5),
    Icon.COLLAPSED.ordinal to Rect(113, 68, 5, 7),
    ATLAS_WHITE to Rect(125, 68, 3, 3),
    (ATLAS_FONT + 32) to Rect(84, 68, 2, 17),
    (ATLAS_FONT + 33) to Rect(39, 68, 3, 17),
    (ATLAS_FONT + 34) to Rect(114, 51, 5, 17),
    (ATLAS_FONT + 35) to Rect(34, 17, 7, 17),
    (ATLAS_FONT + 36) to Rect(28, 34, 6, 17),
    (ATLAS_FONT + 37) to Rect(58, 0, 9, 17),
    (ATLAS_FONT + 38) to Rect(103, 0, 8, 17),
    (ATLAS_FONT + 39) to Rect(86, 68, 2, 17),
    (ATLAS_FONT + 40) to Rect(42, 68, 3, 17),
    (ATLAS_FONT + 41) to Rect(45, 68, 3, 17),
    (ATLAS_FONT + 42) to Rect(34, 34, 6, 17),
    (ATLAS_FONT + 43) to Rect(40, 34, 6, 17),
    (ATLAS_FONT + 44) to Rect(48, 68, 3, 17),
    (ATLAS_FONT + 45) to Rect(51, 68, 3, 17),
    (ATLAS_FONT + 46) to Rect(54, 68, 3, 17),
    (ATLAS_FONT + 47) to Rect(124, 34, 4, 17),
    (ATLAS_FONT + 48) to Rect(46, 34, 6, 17),
    (ATLAS_FONT + 49) to Rect(52, 34, 6, 17),
    (ATLAS_FONT + 50) to Rect(58, 34, 6, 17),
    (ATLAS_FONT + 51) to Rect(64, 34, 6, 17),
    (ATLAS_FONT + 52) to Rect(70, 34, 6, 17),
    (ATLAS_FONT + 53) to Rect(76, 34, 6, 17),
    (ATLAS_FONT + 54) to Rect(82, 34, 6, 17),
    (ATLAS_FONT + 55) to Rect(88, 34, 6, 17),
    (ATLAS_FONT + 56) to Rect(94, 34, 6, 17),
    (ATLAS_FONT + 57) to Rect(100, 34, 6, 17),
    (ATLAS_FONT + 58) to Rect(57, 68, 3, 17),
    (ATLAS_FONT + 59) to Rect(60, 68, 3, 17),
    (ATLAS_FONT + 60) to Rect(106, 34, 6, 17),
    (ATLAS_FONT + 61) to Rect(112, 34, 6, 17),
    (ATLAS_FONT + 62) to Rect(118, 34, 6, 17),
    (ATLAS_FONT + 63) to Rect(119, 51, 5, 17),
    (ATLAS_FONT + 64) to Rect(18, 0, 10, 17),
    (ATLAS_FONT + 65) to Rect(41, 17, 7, 17),
    (ATLAS_FONT + 66) to Rect(48, 17, 7, 17),
    (ATLAS_FONT + 67) to Rect(55, 17, 7, 17),
    (ATLAS_FONT + 68) to Rect(111, 0, 8, 17),
    (ATLAS_FONT + 69) to Rect(0, 35, 6, 17),
    (ATLAS_FONT + 70) to Rect(6, 35, 6, 17),
    (ATLAS_FONT + 71) to Rect(119, 0, 8, 17),
    (ATLAS_FONT + 72) to Rect(18, 17, 8, 17),
    (ATLAS_FONT + 73) to Rect(63, 68, 3, 17),
    (ATLAS_FONT + 74) to Rect(66, 68, 3, 17),
    (ATLAS_FONT + 75) to Rect(62, 17, 7, 17),
    (ATLAS_FONT + 76) to Rect(12, 51, 6, 17),
    (ATLAS_FONT + 77) to Rect(28, 0, 10, 17),
    (ATLAS_FONT + 78) to Rect(67, 0, 9, 17),
    (ATLAS_FONT + 79) to Rect(76, 0, 9, 17),
    (ATLAS_FONT + 80) to Rect(69, 17, 7, 17),
    (ATLAS_FONT + 81) to Rect(85, 0, 9, 17),
    (ATLAS_FONT + 82) to Rect(76, 17, 7, 17),
    (ATLAS_FONT + 83) to Rect(18, 51, 6, 17),
    (ATLAS_FONT + 84) to Rect(24, 51, 6, 17),
    (ATLAS_FONT + 85) to Rect(26, 17, 8, 17),
    (ATLAS_FONT + 86) to Rect(83, 17, 7, 17),
    (ATLAS_FONT + 87) to Rect(38, 0, 10, 17),
    (ATLAS_FONT + 88) to Rect(90, 17, 7, 17),
    (ATLAS_FONT + 89) to Rect(30, 51, 6, 17),
    (ATLAS_FONT + 90) to Rect(36, 51, 6, 17),
    (ATLAS_FONT + 91) to Rect(69, 68, 3, 17),
    (ATLAS_FONT + 92) to Rect(124, 51, 4, 17),
    (ATLAS_FONT + 93) to Rect(72, 68, 3, 17),
    (ATLAS_FONT + 94) to Rect(42, 51, 6, 17),
    (ATLAS_FONT + 95) to Rect(15, 68, 4, 17),
    (ATLAS_FONT + 96) to Rect(48, 51, 6, 17),
    (ATLAS_FONT + 97) to Rect(54, 51, 6, 17),
    (ATLAS_FONT + 98) to Rect(97, 17, 7, 17),
    (ATLAS_FONT + 99) to Rect(0, 52, 5, 17),
    (ATLAS_FONT + 100) to Rect(104, 17, 7, 17),
    (ATLAS_FONT + 101) to Rect(60, 51, 6, 17),
    (ATLAS_FONT + 102) to Rect(19, 68, 4, 17),
    (ATLAS_FONT + 103) to Rect(66, 51, 6, 17),
    (ATLAS_FONT + 104) to Rect(111, 17, 7, 17),
    (ATLAS_FONT + 105) to Rect(75, 68, 3, 17),
    (ATLAS_FONT + 106) to Rect(78, 68, 3, 17),
    (ATLAS_FONT + 107) to Rect(72, 51, 6, 17),
    (ATLAS_FONT + 108) to Rect(81, 68, 3, 17),
    (ATLAS_FONT + 109) to Rect(48, 0, 10, 17),
    (ATLAS_FONT + 110) to Rect(118, 17, 7, 17),
    (ATLAS_FONT + 111) to Rect(0, 18, 7, 17),
    (ATLAS_FONT + 112) to Rect(7, 18, 7, 17),
    (ATLAS_FONT + 113) to Rect(14, 34, 7, 17),
    (ATLAS_FONT + 114) to Rect(23, 68, 4, 17),
    (ATLAS_FONT + 115) to Rect(5, 52, 5, 17),
    (ATLAS_FONT + 116) to Rect(27, 68, 4, 17),
    (ATLAS_FONT + 117) to Rect(21, 34, 7, 17),
    (ATLAS_FONT + 118) to Rect(78, 51, 6, 17),
    (ATLAS_FONT + 119) to Rect(94, 0, 9, 17),
    (ATLAS_FONT + 120) to Rect(84, 51, 6, 17),
    (ATLAS_FONT + 121) to Rect(90, 51, 6, 17),
    (ATLAS_FONT + 122) to Rect(10, 68, 5, 17),
    (ATLAS_FONT + 123) to Rect(31, 68, 4, 17),
    (ATLAS_FONT + 124) to Rect(96, 51, 6, 17),
    (ATLAS_FONT + 125) to Rect(35, 68, 4, 17),
    (ATLAS_FONT + 126) to Rect(102, 51, 6, 17),
    (ATLAS_FONT + 127) to Rect(108, 51, 6, 17),
)